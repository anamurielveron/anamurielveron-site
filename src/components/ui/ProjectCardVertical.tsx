...
export default function ProjectCard({ project }: { project: Project }) {
    return (
        <div className='flex flex-col border border-accent w-72 h-110 shrink-0
                        hover:border-b-6 transition-all group/card'>
            
            {/* Thumbnail */}
            <div className='relative w-full border-b border-accent overflow-hidden'
